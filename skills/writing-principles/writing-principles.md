...
| "Run the tests"               | "Run `pytest tests/`"                           | Missing command      |
...
| Tool substitution         | "Format code" → uses a different formatter          | "Format with the project's configured formatter (e.g., `prettier`, `black`, `ruff format`). Do not use other formatters unless instructed." |
...
| Before                                                                  | After                                        | Violation            |
| ----------------------------------------------------------------------- | -------------------------------------------- | -------------------- |
| "Run tests", "You should lint the code", "Formatting is done with the project formatter" | "Run tests", "Lint code", "Format with the project formatter" | Mixed voice          |
