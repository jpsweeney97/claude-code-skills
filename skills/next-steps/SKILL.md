...
| Use action-plan | Use session-sized implementation planning instead |
|---|---|
...
| Output feeds into deeper planning sessions | Output feeds directly into coding work |

If the conversation already has a clear implementation path, use session-sized implementation planning instead.
